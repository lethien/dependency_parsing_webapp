...
import time, random
import numpy as np
from .utils import read_conll, read_conll_predict, write_conll, load_embeddings_file, parse_sentence_to_conll_entry
...
class jPosDepLearner:
    ...
    def Predict(self, conll_path):
        with open(conll_path, encoding="utf8") as conllFP:
    ...
    def Tag(self, input_sentences):
        for sentence in parse_sentence_to_conll_entry(input_sentences, self.c2i, self.wordsCount):
